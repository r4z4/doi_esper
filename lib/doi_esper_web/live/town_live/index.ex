defmodule DoiEsperWeb.TownLive.Index do
  ...
  @impl true
  def handle_info(%{topic: @xml_parse, payload: msg}, socket) do
    IO.inspect(socket)
    IO.puts "Handle Broadcast for XML Data"
    {:noreply,
      socket
      |> assign(:xml_data, msg[:data])
    }
  end
