defmodule DoiEsperWeb.Router do
  ...
  scope "/", DoiEsperWeb do
    ...
    live "/postgis", PostgisLive.Index, :index
  end
  ...
  scope "/", DoiEsperWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{DoiEsperWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", DoiEsperWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{DoiEsperWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", DoiEsperWeb do
    ...
    live_session :current_user,
      on_mount: [{DoiEsperWeb.UserAuth, :mount_current_user}] do
